...
const clickEvent = (e) => {
  ...
  if (sceneFlagCount === 1) {
    if (e.target.id === scene1ObjConts[0].id) {
      location.href = "./../works/mikiohasui/005.html";
    } else if (e.target.id === scene1ObjConts[1].id) {
      location.href = "./../works/mikiohasui/001.html";
    } else if (e.target.id === scene1ObjConts[2].id) {
      location.href = "./../works/mikiohasui/006.html";
    } else if (e.target.id === scene1ObjConts[3].id) {
      location.href = "./../works/mikiohasui/004.html";
    } else if (e.target.id === scene1ObjConts[4].id) {
      location.href = "./../works/mikiohasui/002.html";
    } else if (e.target.id === scene1ObjConts[5].id) {
      location.href = "./../works/mikiohasui/010.html";
    } else if (e.target.id === scene1ObjConts[6].id) {
      location.href = "./../works/mikiohasui/008.html";
    } else if (e.target.id === scene1ObjConts[7].id) {
      location.href = "./../works/mikiohasui/007.html";
    }
  } else if (sceneFlagCount === 2) {
    if (e.target.id === scene2ObjConts[0].id) {
      location.href = "./../works/mikiohasui/012.html";
    } else if (e.target.id === scene2ObjConts[1].id) {
      location.href = "./../works/mikiohasui/013.html";
    } else if (e.target.id === scene2ObjConts[2].id) {
      location.href = "./../works/mikiohasui/009.html";
    } else if (e.target.id === scene2ObjConts[3].id) {
      location.href = "./../works/mikiohasui/011.html";
    } else if (e.target.id === scene2ObjConts[4].id) {
      location.href = "./../works/mikiohasui/015.html";
    }
  }
