...
const sceneReady1 = () => {
  ...
  ringScene1to2.setAttribute("position", "3 -1.5 0");
  ...
  ringSceneBox1to2.setAttribute("materil", "transparent: true; alphaTest: 10");
  ...
  ringScene1.push(ringScene1to2);
  ringBox.push(ringSceneBox1to2);
  ...
  for (let i = 0; i <= 7; i++) {
    ...
    if (i === 0) {
      aBox.setAttribute("position", "-2 1.4 -5");
      aBox.setAttribute("scale", "1.3 1 1");
      mark.setAttribute("position", "-1.2 1 -5");
    } else if (i === 1) {
      aBox.setAttribute("position", "0 1.3 -5");
      aBox.setAttribute("scale", "1.3 1 1");
      mark.setAttribute("position", "1 1 -5");
    } else if (i === 2) {
      aBox.setAttribute("position", "2.2 1.3 -5");
      aBox.setAttribute("scale", "1.3 1 1");
      mark.setAttribute("position", "3.2 0.95 -5");
    } else if (i === 3) {
      aBox.setAttribute("position", "-1 -0.2 -5");
      aBox.setAttribute("scale", "1.3 1 1");
      // mark.setAttribute("scale", "0.4 0.4 0.4");
      mark.setAttribute("position", "0 -0.5 -5");
      // mark.setAttribute("rotation", "180 -30 0");
    } else if (i === 4) {
      aBox.setAttribute("position", "1 -0.2 -5");
      aBox.setAttribute("scale", "1.3 1 1");
      mark.setAttribute("position", "2.1 -0.6 -5");
      // mark.setAttribute("rotation", "180 0 0");
    } else if (i === 5) {
      aBox.setAttribute("position", "-2 0.2 3.5");
      aBox.setAttribute("scale", "1.3 1 1");
      mark.setAttribute("position", "-3.1 -0.3 3.5");
      mark.setAttribute("rotation", "180 0 0");
      mark.setAttribute("scale", "0.25 0.25 0.25");
    } else if (i === 6) {
      aBox.setAttribute("position", "0.2 0.1 3.5");
      aBox.setAttribute("scale", "1.4 1 1");
      mark.setAttribute("position", "-0.9 -0.3 3.5");
      mark.setAttribute("rotation", "180 0 0");
      mark.setAttribute("scale", "0.25 0.25 0.25");
    } else if (i === 7) {
      aBox.setAttribute("position", "2.4 0.1 3.5");
      aBox.setAttribute("scale", "1.3 1 1");
      mark.setAttribute("position", "1.3 -0.35 3.5");
      mark.setAttribute("rotation", "180 30 0");
      mark.setAttribute("scale", "0.25 0.25 0.25");
    }
 ...
 sceneReady2 = () => {
  ...
  ringScene2to1.setAttribute("position", "-1.5 -2 -3.5");
  ...
  ringScene2.push(ringScene2to1);
  ringBox.push(ringSceneBox2to1);
  ...
  for (let i = 0; i <= 4; i++) {
    ...
    if (i === 0) {
      aBox.setAttribute("position", "-0.8 0 3");
      aBox.setAttribute("scale", "1.5 1.3 1");
      mark.setAttribute("position", "-1.95 -0.5 3");
      mark.setAttribute("rotation", "180 0 0");
      mark.setAttribute("scale", "0.23 0.23 0.23");
    } else if (i === 1) {
      aBox.setAttribute("position", "1.7 0.1 3");
      aBox.setAttribute("scale", "2.1 1.6 1");
      mark.setAttribute("position", "0.3 -0.6 3");
      mark.setAttribute("rotation", "180 30 0");
      mark.setAttribute("scale", "0.28 0.28 0.28");
    } else if (i === 2) {
      aBox.setAttribute("position", "5 0.2 -0.2");
      aBox.setAttribute("scale", "3 1 1");
      mark.setAttribute("position", "5 -0.2 0.9");
      mark.setAttribute("rotation", "180 90 0");
    } else if (i === 3) {
      aBox.setAttribute("position", "5 0.3 -2.8");
      aBox.setAttribute("scale", "1.7 1.3 1");
      aBox.setAttribute("rotation", "0 110 0");
      mark.setAttribute("position", "5 -0.25 -1.5");
      mark.setAttribute("rotation", "180 90 0");
      mark.setAttribute("scale", "0.35 0.35 0.35");
    } else if (i === 4) {
      aBox.setAttribute("position", "3 0.2 -4");
      mark.setAttribute("position", "3 -0.2 -2.8");
      mark.setAttribute("rotation", "180 100 0");
      mark.setAttribute("scale", "0.25 0.25 0.25");
    }
